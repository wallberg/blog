...
The new theory is both radically different from the prevailing theories and contains gaps in evidence and understanding. And just as in the *Origin of Species*, it is backed by volumes of evidence that goes against that prevailing thinking, including that of evolutionary theorists. The forward is provided by [Ernst Mayer](https://en.wikipedia.org/wiki/Ernst_Mayr), another well known evolutionary biologist, who says:
...
The book begins by explaining the difference between Darwinism and Neo-Darwinism.

Darwin presented a theory of natural selection based on descent with modification.
